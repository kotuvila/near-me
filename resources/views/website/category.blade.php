...
<body class="body-wrapper">
        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-lg-12 col-md-12 align-content-center">
                    ...
                    <form action="{{ route('searchby') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-2 align-self-center">
                                <button style="background-color: #4CAF50" type="submit" class="btn text-white"><i></i>
                                    &nbsp;
                                    &nbsp;&nbsp;&nbsp;Search&nbsp;&nbsp;
                            </div>
    ...
    <section style="background-color: #4CAF50" class="page-search">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <!-- Advance Search -->
                    ...
                    <div class="category-sidebar">
                        <div class="widget category-list">
                            ...
                            <ul class="category-list">
                                @foreach ($cats as $cat)
                                    <li><a href="category.html">{{ $cat->name }} <span></span></a></li>
                                @endforeach
                            </ul>
                        </div>
                        ...
                        <div class="widget category-list">
                            ...
                            <ul class="category-list">
                                @foreach ($areas as $are)
                                    <li><a href="category.html">{{ $are->name }}<span></span></a></li>
                                @endforeach
                            </ul>
                        </div>
